...
module.exports = __webpack_require__("rJ8Y");
...
/* harmony default export */ __webpack_exports__["default"] = ((req, res) => {
  ...
  switch (req.method) {
    case "GET":
      console.log(req.method);
      _models_Product__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].findOne({
        _id: pid
      }, (err, result) => {
        if (err) {
          console.log(err);
    ...
    case "DELETE":
      console.log("delete");
      _models_Product__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].findByIdAndRemove({
        _id: pid
      }, error => {
        if (!error) {
          console.log("deleted");
